...
<div class="main-container">
    <div class="pd-ltr-20">
        ...
        <div class="card-box pd-20 height-100-p mb-30">
            ...
            <form action="<?= base_url('/suratkuasa/masyarakat/submitMasyarakat'); ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group row mb-3">
                    <label for="tanggal_dikeluarkan" class="col-sm-3 col-form-label">Tanggal Dikeluarkan:</label>
                    <div class="col-sm-9">
